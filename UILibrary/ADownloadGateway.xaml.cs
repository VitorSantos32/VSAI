    ...
    public partial class ADownloadGateway : UserControl
    {
        ...
        public ADownloadGateway(string Name, string Path)
        {
            ...
            DownloadButton.Click += async (s, e) =>
            {
                ...
                string owner = VSAI.Class.Dictionary.dropdownState.ContainsKey("Repo Owner") ? VSAI.Class.Dictionary.dropdownState["Repo Owner"].ToString() : "Babyhamsta";
                string repoName = VSAI.Class.Dictionary.dropdownState.ContainsKey("Repo Name") ? VSAI.Class.Dictionary.dropdownState["Repo Name"].ToString() : "VSAI";
                string branch = VSAI.Class.Dictionary.dropdownState.ContainsKey("Repo Branch") ? VSAI.Class.Dictionary.dropdownState["Repo Branch"].ToString() : "main";

                var downloadUri = new Uri($"https://github.com/{owner}/{repoName}/raw/{branch}/{Path}/{encodedName}");
        ...
        private static void SetupHttpClientHeaders()
        {
            ...
            {
                httpClient.DefaultRequestHeaders.Add("User-Agent", "VSAI");
            }
